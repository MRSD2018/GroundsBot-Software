...
stereo_sgbm( )
{
    ...
    image_ros.header.frame_id = "/stereo_camera";
...
main( int argc, char** argv )
{
    ...
    message_filters::Subscriber< sensor_msgs::Image > sub_imgL( nh, "/stereo_camera/left/image_rect", 2 );
    message_filters::Subscriber< sensor_msgs::Image > sub_imgR( nh, "/stereo_camera/right/image_rect", 2 );
    ...
    depthImg_pub = nh.advertise< sensor_msgs::Image >( "/stereo_camera/left/depth", 1 );
